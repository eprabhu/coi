...
ELSEIF AV_MODULE_CODE = 8 THEN
	...
	WHERE T3.PERSON_ID = AV_LOGGED_IN_PERSON_ID)) OR ADMIN_PERSON_ID = AV_LOGGED_IN_PERSON_ID);
        ...
        WHERE T1.DISCLOSURE_ID = AV_MODULE_ITEM_KEY AND T1.ASSIGNEE_PERSON_ID = AV_LOGGED_IN_PERSON_ID AND T2.REVIEW_STATUS_CODE IN (7) AND T1.REVIEW_STATUS_TYPE_CODE <> 2;
        IF LI_COUNT > 0 THEN
            RETURN LI_AUTHORIZED;
        END IF;
...
ELSEIF AV_MODULE_CODE = 23 THEN
	...
	WHERE T3.PERSON_ID = AV_LOGGED_IN_PERSON_ID)) OR ADMIN_PERSON_ID = AV_LOGGED_IN_PERSON_ID);
        ...
        WHERE T1.OPA_DISCLOSURE_ID = AV_MODULE_ITEM_KEY AND T1.ASSIGNEE_PERSON_ID = AV_LOGGED_IN_PERSON_ID AND T2.REVIEW_STATUS_CODE IN (7) AND T1.REVIEW_STATUS_TYPE_CODE <> 3;
        IF LI_COUNT > 0 THEN
            RETURN LI_AUTHORIZED;
        END IF;
