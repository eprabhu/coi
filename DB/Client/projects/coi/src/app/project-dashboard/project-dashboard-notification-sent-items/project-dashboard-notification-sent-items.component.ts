...
import { NotificationDetails } from '../project-dashboard.interface';
import { CommonService } from '../../common/services/common.service';

@Component({
    selector: 'app-project-dashboard-notification-sent-items',
    templateUrl: './project-dashboard-notification-sent-items.component.html',
    styleUrls: ['./project-dashboard-notification-sent-items.component.scss']
})
export class ProjectDashboardNotificationSentItemsComponent {
    ...
    isDesc: { [key: string]: boolean } = {
        sendDate: true  // sent date is default sorting
    };
