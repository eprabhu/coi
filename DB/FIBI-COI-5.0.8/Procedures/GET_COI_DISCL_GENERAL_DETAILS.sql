...
SET LS_DYN_SQL = CONCAT('SELECT ', AV_COLUMN_NAMES, ' FROM
	...
	INNER JOIN COI_DISCL_PROJECTS t9 ON t9.DISCLOSURE_ID = t1.DISCLOSURE_ID
	...
	TITLE  AS PROPOSAL_TITLES, EXTERNAL_SYSTEM_REF_ID FROM COI_PROJECT_PROPOSAL_V ) t5 ON t5.PROPOSAL_ID = t9.MODULE_ITEM_KEY
	LEFT  JOIN (SELECT AWARD_NUMBER, EXTERNAL_SYSTEM_REF_ID,
	TITLE AS AWARD_TITLES FROM COI_PROJECT_AWARD_V ) t6  ON t6.AWARD_NUMBER = t9.MODULE_ITEM_KEY
