...
END IF;
    ...
    ELSE
        SET LS_DYN_SQL = CONCAT(LS_DYN_SQL, ' SELECT *, 
								FN_DISCLOSURE_TOTAL_COMMENT_COUNT(T.OPA_DISCLOSURE_ID, ''', AV_PERSON_ID, ''', 23) AS DISCLOSURE_COMMENT_COUNT 
        ...
        SET OPA_SELECTED_FIELDS= CONCAT('T1.OPA_DISCLOSURE_ID, T1.OPA_DISCLOSURE_NUMBER, T1.OPA_CYCLE_NUMBER,
            ...
            CASE    WHEN T8.ASSIGNEE_PERSON_ID IS NULL THEN CONCAT(T15.DESCRIPTION, " : ", "null", " : ",T14.DESCRIPTION, " : ",T14.REVIEW_STATUS_CODE)
					...
					END
			SEPARATOR ";") AS REVIEWERS, T1.VERSION_NUMBER, T1.VERSION_STATUS, T1.EXPIRATION_DATE ');
	...
	SET LS_DYN_SQL = CONCAT(LS_DYN_SQL, OPA_SELECTED_FIELDS, ' FROM OPA_DISCLOSURE T1 ', 
            ...
            AND T1.VERSION_NUMBER IN (SELECT MAX(OD.VERSION_NUMBER) FROM OPA_DISCLOSURE OD WHERE OD.OPA_DISCLOSURE_ID = T1.OPA_DISCLOSURE_ID)
