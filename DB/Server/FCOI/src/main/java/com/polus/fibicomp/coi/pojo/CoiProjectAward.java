...
@Entity
@Table(name = "COI_PROJECT_AWARD")
@EntityListeners(AuditingEntityListener.class)
public class CoiProjectAward implements Serializable {
	...
	@JoinColumn(foreignKey = @ForeignKey(name = "COI_PROJECT_AWARD_FK1"), name = "COI_PROJECT_TYPE_CODE", referencedColumnName = "COI_PROJECT_TYPE_CODE", insertable = false, updatable = false)
