...
BEGIN
    ...
    AND INDUSTRY_CATEGORY_ID NOT IN (
        SELECT icc.INDUSTRY_CATEGORY_ID FROM INDUSTRY_CATEGORY_CODE icc JOIN INDUSTRY_CATEGORY_TYPE ict ON icc.INDUSTRY_CATEGORY_TYPE_CODE = ict.INDUSTRY_CATEGORY_TYPE_CODE WHERE ict.SOURCE = 'S'
    );
