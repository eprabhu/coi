DELIMITER //
CREATE  PROCEDURE `GET_RULE_EVALUATE_VALIDATION`(
...
elseif AV_MODULE_CODE = 24 then
        SELECT HOME_UNIT INTO LS_LEAD_UNIT_NUMBER
         FROM COI_TRAVEL_DISCLOSURE WHERE TRAVEL_DISCLOSURE_ID = AV_MODULE_ITEM_KEY;
...
IF AV_MODULE_CODE = 5 THEN
		...
		RULE_NEGO_CURSOR_LOOP : LOOP
				FETCH RULE_NEGOTIATION_CURSOR INTO LS_RULE_ID,LS_RULE_TYPE,LS_RULE_EXPRESSION,LS_USER_MESSAGE;
				IF DONE1 THEN
