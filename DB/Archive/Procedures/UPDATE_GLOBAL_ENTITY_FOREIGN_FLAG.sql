DELIMITER //
CREATE PROCEDURE `UPDATE_GLOBAL_ENTITY_FOREIGN_FLAG`(AV_ENTITY_ID INT, AV_ENTITY_NUMBER INT)
BEGIN

        SET SESSION group_concat_max_len = 1000000;

    	CALL GET_ENTITY_HIERARCHY(AV_ENTITY_NUMBER);
        ...
        IF NOT EXISTS (SELECT 1 FROM ENTITY WHERE ( EXISTS ( SELECT 1 FROM ENTITY_HIERARCHY_TEMP_TABLE WHERE COUNTRY_CODE NOT IN (
            ...
            UPDATE ENTITY SET IS_FOREIGN = 'N' WHERE FIND_IN_SET(ENTITY_ID, @entity_ids) OR ENTITY_ID = AV_ENTITY_ID;
        END IF;
