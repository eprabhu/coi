...
CREATE PROCEDURE COI_COPY_GLOBAL_ENTITY(
	...
	AV_ENTITY_STATUS_TYPE_CODE VARCHAR(3)
)
BEGIN
...
DECLARE LI_COPIED_ENTITY_ID 		INT;
	...
	INSERT INTO ENTITY
		...
		IS_DUNS_MONITORING_ENABLE)
	SELECT
		PRIMARY_NAME, FOREIGN_NAME, PRIOR_NAME, SHORT_NAME, DUNS_NUMBER, UEI_NUMBER, CAGE_NUMBER, ENTITY_OWNERSHIP_TYPE_CODE, AV_ENTITY_STATUS_TYPE_CODE,
		OPERATING_STATUS_TYPE_CODE, DOCUMENT_STATUS_TYPE_CODE, BUSINESS_TYPE_CODE, WEBSITE_ADDRESS, START_DATE, INCORPORATION_DATE, INCORPORATED_IN, CONGRESSIONAL_DISTRICT,
		NUMBER_OF_EMPLOYEES, FEDERAL_EMPLOYER_ID, CERTIFIED_EMAIL, ACTIVITY_TEXT, CURRENCY_CODE, ENTITY_SOURCE_TYPE_CODE, PHONE_NUMBER, PRIMARY_ADDRESS_LINE_1,
		PRIMARY_ADDRESS_LINE_2, CITY, STATE, POST_CODE, COUNTRY_CODE, HUMAN_SUB_ASSURANCE, ANIMAL_WELFARE_ASSURANCE, ANIMAL_ACCREDITATION, APPROVED_BY, APPROVED_TIMESTAMP,
		...
		'PENDING' AS VERSION_STATUS, IS_DUNS_MATCHED, ORIGINAL_ENTITY_ID, IS_DUNS_MONITORING_ENABLE
    ...
    */
	...
	INSERT INTO ENTITY_SPONSOR_INFO
		...
		SPONSOR_NAME, TRANSLATED_NAME, DUNS_NUMBER, UEI_NUMBER, CAGE_NUMBER, PRIMARY_ADDRESS_LINE_1, PRIMARY_ADDRESS_LINE_2, CITY, STATE, POST_CODE,
		COUNTRY_CODE, EMAIL_ADDRESS, PHONE_NUMBER, IS_COPY, COMMENTS, ROLODEX_ID, IS_CREATED_FROM_IMPORT_ENTITY )
		...
		DUNNING_CAMPAIGN_ID, CUSTOMER_NUMBER, UPDATE_TIMESTAMP, UPDATED_BY,
		SPONSOR_NAME, TRANSLATED_NAME, DUNS_NUMBER, UEI_NUMBER, CAGE_NUMBER, PRIMARY_ADDRESS_LINE_1, PRIMARY_ADDRESS_LINE_2, CITY, STATE, POST_CODE,
        COUNTRY_CODE, EMAIL_ADDRESS, PHONE_NUMBER, 'N', COMMENTS, ROLODEX_ID, IS_CREATED_FROM_IMPORT_ENTITY FROM ENTITY_SPONSOR_INFO WHERE ENTITY_ID = AV_ENTITY_ID;
	...
	INSERT INTO ENTITY_SUB_ORG_INFO
		...
		ORGANIZATION_NAME, DUNS_NUMBER, UEI_NUMBER, CAGE_NUMBER, PRIMARY_ADDRESS_LINE_1, PRIMARY_ADDRESS_LINE_2, CITY, STATE, POST_CODE, COUNTRY_CODE, EMAIL_ADDRESS,
		PHONE_NUMBER, HUMAN_SUB_ASSURANCE, ANIMAL_WELFARE_ASSURANCE, ANIMAL_ACCREDITATION, CONGRESSIONAL_DISTRICT, INCORPORATED_IN, INCORPORATED_DATE,
		NUMBER_OF_EMPLOYEES, FEDERAL_EMPLOYER_ID, IS_COPY, ROLODEX_ID, IS_CREATED_FROM_IMPORT_ENTITY)
        ...
        ORGANIZATION_NAME, DUNS_NUMBER, UEI_NUMBER, CAGE_NUMBER, PRIMARY_ADDRESS_LINE_1, PRIMARY_ADDRESS_LINE_2, CITY, STATE, POST_CODE, COUNTRY_CODE, EMAIL_ADDRESS,
        PHONE_NUMBER, HUMAN_SUB_ASSURANCE, ANIMAL_WELFARE_ASSURANCE, ANIMAL_ACCREDITATION, CONGRESSIONAL_DISTRICT, INCORPORATED_IN, INCORPORATED_DATE,
        NUMBER_OF_EMPLOYEES, FEDERAL_EMPLOYER_ID, 'N', ROLODEX_ID, IS_CREATED_FROM_IMPORT_ENTITY FROM ENTITY_SUB_ORG_INFO WHERE ENTITY_ID = AV_ENTITY_ID;
