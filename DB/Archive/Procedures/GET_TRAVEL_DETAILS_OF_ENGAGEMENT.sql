...
BEGIN
    ...
    SELECT
        ...
        t1.HOME_UNIT,
        t1.ADMIN_PERSON_ID,
        t12.FULL_NAME as ADMIN_FULL_NAME,
        t1.ADMIN_GROUP_ID,
        t13.ADMIN_GROUP_NAME,
        t1.CERTIFIED_AT,
        t1.REVIEW_STATUS_CODE,
        t1.UPDATE_TIMESTAMP,
        t16.FULL_NAME as UPDATE_USER_FULL_NAME,
        t14.DESCRIPTION as REVIEW_STATUS_DESCRIPTION,
        t1.DOCUMENT_STATUS_CODE,
        t15.DESCRIPTION as DOCUMENT_STATUS_DESCRIPTION,
    ...
    LEFT JOIN (SELECT TRAVEL_DISCLOSURE_ID, JSON_ARRAYAGG(
            JSON_OBJECT(
                ...
                'stayStartDate', DATE(t01.STAY_START_DATE),
				'stayEndDate', DATE(t01.STAY_END_DATE),
				'countryName', t9.COUNTRY_NAME
                )) as destination
		FROM COI_TRAVEL_DESTINATIONS t01
		LEFT JOIN COUNTRY t9 ON t9.COUNTRY_CODE = t01.COUNTRY_CODE
        group by TRAVEL_DISCLOSURE_ID )t2 ON t2.TRAVEL_DISCLOSURE_ID = t1.TRAVEL_DISCLOSURE_ID
    ...
    LEFT JOIN PERSON t12 on t12.PERSON_ID = t1.ADMIN_PERSON_ID
    LEFT JOIN ADMIN_GROUP t13 on t13.ADMIN_GROUP_ID = t1.ADMIN_GROUP_ID
    INNER JOIN COI_TRAVEL_REVIEW_STATUS t14 on t14.REVIEW_STATUS_CODE = t1.REVIEW_STATUS_CODE
    INNER JOIN COI_TRAVEL_DOCUMENT_STATUS_TYPE t15 on t15.DOCUMENT_STATUS_CODE = t1.DOCUMENT_STATUS_CODE
    INNER JOIN PERSON t16 on t16.PERSON_ID = t1.UPDATED_BY
