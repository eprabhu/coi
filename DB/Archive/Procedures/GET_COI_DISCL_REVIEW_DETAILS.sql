...
SET LS_DYN_SQL = CONCAT('SELECT ', AV_COLUMN_NAMES, ' FROM
	(SELECT t2.FULL_NAME AS REVIEWER_NAME,
		t3.DESCRIPTION AS REVIEW_LOCATION,
		t4.DESCRIPTION AS REVIEWER_REVIEW_STATUS,
		DATE(t1.CREATE_TIMESTAMP) AS REVIEW_ASSIGNED_DATE,
		t1.DESCRIPTION AS REVIEW_ASSIGN_DESCRIPTION
	FROM COI_REVIEW t1
