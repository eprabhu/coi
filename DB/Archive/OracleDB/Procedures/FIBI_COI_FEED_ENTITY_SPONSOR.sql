                ...
                BEGIN
                    ...
                    IF AV_SPONCOR_CODE IS NULL THEN
                       ...
                       SELECT SEQ_ROLODEX_ID.NEXTVAL INTO LI_SPON_SEQ_ROLODEX_ID FROM dual;
                        ...
                        INSERT INTO ROLODEX(ROLODEX_ID, LAST_NAME, FIRST_NAME, MIDDLE_NAME, ORGANIZATION, ADDRESS_LINE_1, ADDRESS_LINE_2, ADDRESS_LINE_3, EMAIL_ADDRESS, CITY, COUNTY, STATE, POSTAL_CODE, COMMENTS, PHONE_NUMBER, COUNTRY_CODE, SPONSOR_CODE, OWNED_BY_UNIT, SPONSOR_ADDRESS_FLAG, CREATE_USER, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID, ACTV_IND, COMMENTS)
                        VALUES (LI_SPON_SEQ_ROLODEX_ID, LS_LAST_NAME, LS_FIRST_NAME, LS_MIDDLE_NAME, AV_PRIMARY_NAME, AV_SPON_ADDRESS_LINE_1, AV_SPON_ADDRESS_LINE_2, LS_ADDRESS_LINE_3, AV_EMAIL_ADDRESS, AV_SPON_CITY, LS_COUNTY, AV_SPON_STATE, AV_SPON_POSTAL_CODE, LS_COMMENTS, AV_TELEPHONE_NUMBER, AV_SPON_COUNTRY_CODE, LI_SEQ_SPONSOR_CODE, LS_OWNED_BY_UNIT, LS_SPONSOR_ADDRESS_FLAG,
                        LS_UPDATE_USER, SYSDATE(), LS_UPDATE_USER, LI_VER_NBR, SYS_GUID(), LS_ACTV_IND, AV_COMMENTS);
                    ...
                    ELSE
                        ...
                        CREATE_USER = LS_UPDATE_USER, UPDATE_TIMESTAMP = SYSDATE(), UPDATE_USER = LS_UPDATE_USER, VER_NBR = LI_VER_NBR, OBJ_ID = SYS_GUID(), ACTV_IND = LS_ACTV_IND                        WHERE ROLODEX_ID IN (LI_SPON_SEQ_ROLODEX_ID);
