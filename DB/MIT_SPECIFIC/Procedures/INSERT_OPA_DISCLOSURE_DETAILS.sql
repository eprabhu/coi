...
SELECT OPA_PERSON_ID INTO LI_OPA_PERSON_ID FROM OPA_PERSON WHERE PERSON_ID = AV_PERSON_ID;

INSERT INTO OPA_DISCLOSURE(OPA_DISCLOSURE_NUMBER, OPA_CYCLE_NUMBER, PERSON_ID, OPA_PERSON_ID, HOME_UNIT, CREATE_USER, CREATE_TIMESTAMP, UPDATED_BY, UPDATE_TIMESTAMP, REVIEW_STATUS_CODE, DISPOSITION_STATUS_CODE, VERSION_STATUS, VERSION_NUMBER)
VALUES 
(CONCAT(LS_PREFIX, LS_OPA_DISCLOSURE_NUMBER), LI_OPA_CYCLE_NUMBER, AV_PERSON_ID, LI_OPA_PERSON_ID, LS_HOME_UNIT, AV_LOGGEDIN_USER, UTC_TIMESTAMP(), AV_PERSON_ID, UTC_TIMESTAMP(), LS_OPA_REVIEW_STATUS_CODE, LS_DISPOSITION_STATUS_CODE, LS_VERSION_STATUS, LS_VERSION_NUMBER);
