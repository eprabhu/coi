...
BEGIN
	BEGIN
            ...
            IF (UPPER(IS_SPONSOR_SYNC_FLAG) = 'TRUE' OR IS_SPONSOR_SYNC_FLAG = 1) THEN
                ...
                BEGIN
                    ...
                    IF AV_SPONCOR_CODE IS NULL THEN
                        ...
                        IF AV_ROLODEX_ID IS NULL OR AV_ROLODEX_ID = 0  THEN
                        ...
                        ELSE
                            UPDATE ROLODEX SET ADDRESS_LINE_1 = AV_SPON_ADDRESS_LINE_1, ADDRESS_LINE_2 = AV_SPON_ADDRESS_LINE_2, ADDRESS_LINE_3 = LS_ADDRESS_LINE_3, CITY = AV_SPON_CITY,
                                STATE = AV_SPON_STATE, POSTAL_CODE = AV_SPON_POSTAL_CODE, COMMENTS = AV_COMMENTS,
                                COUNTRY_CODE = AV_SPON_COUNTRY_CODE, SPONSOR_CODE = AV_SPONCOR_CODE,
                                EMAIL_ADDRESS = AV_EMAIL_ADDRESS, PHONE_NUMBER = AV_TELEPHONE_NUMBER,
                                CREATE_USER = LS_UPDATE_USER, UPDATE_TIMESTAMP = SYSDATE, UPDATE_USER = LS_UPDATE_USER
                                WHERE ROLODEX_ID = AV_ROLODEX_ID;
                            LI_SPON_SEQ_ROLODEX_ID := AV_ROLODEX_ID;
                        END IF;
                    ...
                    ELSE
                        ...
                        UPDATE SPONSOR SET SPONSOR_NAME = AV_PRIMARY_NAME, ACRONYM = AV_ACRONYM, SPONSOR_TYPE_CODE = AV_SPONSOR_TYPE_CODE, DUN_AND_BRADSTREET_NUMBER = AV_DUNS_NUMBER,
                        CAGE_NUMBER = AV_CAGE_NUMBER, POSTAL_CODE = AV_SPON_POSTAL_CODE, STATE = AV_SPON_STATE, COUNTRY_CODE = AV_SPON_COUNTRY_CODE,
                        ROLODEX_ID = AV_ROLODEX_ID, CREATE_USER = LS_UPDATE_USER, UPDATE_TIMESTAMP = SYSDATE, UPDATE_USER = LS_UPDATE_USER,UEI = AV_UEI, ENTITY_ID = AV_ENTITY_ID
        ...
        IF LI_SPON_SEQ_ROLODEX_ID IS NULL THEN
            LI_SPON_SEQ_ROLODEX_ID := AV_ROLODEX_ID;
        END IF;
		...
		OPEN CUR_GENERIC FOR SELECT LI_SEQ_SPONSOR_CODE AS SPONSOR_CODE,LS_SPONSOR_ERROR_MESGE AS SPONSOR_ERROR, LI_SPON_SEQ_ROLODEX_ID AS ROLODEX_ID FROM DUAL;
