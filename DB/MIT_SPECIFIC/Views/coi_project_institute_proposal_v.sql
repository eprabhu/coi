...
CREATE VIEW `coi_project_institute_proposal_v` AS
 ...
 SELECT
        ...
        (CONVERT( '2' USING LATIN1) COLLATE latin1_swedish_ci) AS `COI_PROJECT_TYPE_CODE`,
        ...
        `coi_int_stage_proposal`.`LINKED_AWARD_PROJECT_NUMBER` AS `LINKED_AWARD_PROJECT_NUMBER`,
