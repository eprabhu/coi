...
BEGIN
    WITH ProjectDisclosureDetails AS (
        ...
        LEFT JOIN (
            ...
            FROM COI_PROJECT_AWARD_V WHERE OVERALL_DISCLOSURE_STATUS = 'DISCLOSURE_COMPLETED' AND AWARD_STATUS_CODE = 6
    ...
    AND (
        (AV_REVIEW_STATUS_CODE != 4) OR
        (AV_REVIEW_STATUS_CODE = 4 AND T1.PROJECT_OVERALL_REVIEW_STATUS = 'Completed')
    )
