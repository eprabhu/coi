...
BEGIN
    ...
    DECLARE LS_LEGACY_DAYS_TO_DUE_DATE INT;
    ...
    FCOI_LOOP: LOOP
        ...
        INSERT INTO TEMP_EXPIRING_DISCL_TO_NOTIFY (DISCLOSURE_ID, DISCLOSURE_NUMBER, PERSON_ID, DISCLOSURE_TYPE, EXPIRATION_DATE, DAYS_TO_DUE_DATE, VERSION_STATUS, CERTIFICATION_DATE)
        SELECT 
            CD.DISCLOSURE_ID,
    ...
    OPEN LEGACY_CURSOR;
    LEGACY_LOOP: LOOP
        FETCH LEGACY_CURSOR INTO LS_LEGACY_DAYS_TO_DUE_DATE;
        IF DONE THEN
            LEAVE LEGACY_LOOP;
        END IF;
        ...
        INSERT INTO TEMP_EXPIRING_DISCL_TO_NOTIFY (DISCLOSURE_ID, DISCLOSURE_NUMBER, PERSON_ID, DISCLOSURE_TYPE, EXPIRATION_DATE, DAYS_TO_DUE_DATE, IS_LEGACY_DISCLOSURE, VERSION_STATUS, CERTIFICATION_DATE, REPORTER_NAME, DEPARTMENT_NUMBER, DEPARTMENT_NAME, DISPOSITION_STATUS)
            ...
            AND CD.EXPIRATION_DATE = DATE_ADD(CURDATE(), INTERVAL LS_LEGACY_DAYS_TO_DUE_DATE DAY)
            AND (
                    NOT EXISTS (
                        SELECT 1
    ...
    OPA_LOOP: LOOP
        ...
        INSERT INTO TEMP_EXPIRING_DISCL_TO_NOTIFY (DISCLOSURE_ID, DISCLOSURE_NUMBER, PERSON_ID, DISCLOSURE_TYPE, EXPIRATION_DATE, DAYS_TO_DUE_DATE, VERSION_STATUS)
        SELECT 
            D.OPA_DISCLOSURE_ID,        
