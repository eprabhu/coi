...
BEGIN
    ...
    IF AV_TAB_TYPE IS NULL OR AV_TAB_TYPE <> 'DELINQUENT' THEN
        ...
        SET LS_JOIN_CONDITION = ' INNER JOIN ELIGIBILITY_UNITS EU ON EU.UNIT_NUMBER = T3.HOME_UNIT ';

        SET SELECTED_FIELD_LIST = ' EU.CAN_EDIT, ';

    ELSEIF AV_TAB_TYPE = 'DELINQUENT' THEN

        SET SELECTED_FIELD_LIST = ' false AS CAN_EDIT, ';
    ...
    SET LS_DYN_SQL = CONCAT(LS_DYN_CTE_SQL,' SELECT * FROM (SELECT ', SELECTED_FIELD_LIST,' FROM PERSON_DISCL_REQUIREMENT T1
            ...
            LEFT JOIN PERSON T5 ON T5.PERSON_ID = T1.UPDATED_BY ', LS_JOIN_CONDITION, '
