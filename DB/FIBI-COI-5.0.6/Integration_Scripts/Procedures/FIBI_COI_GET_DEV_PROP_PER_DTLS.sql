...
OPEN cur_generic FOR
	...
	FIBI_COI_DEV_PER_CERT_FLAG(EPP.proposal_number,EPP.person_id,EPP.prop_person_role_id,EPP.PROJECT_ROLE) AS CERTIFICATION_FLAG,
	FIBI_COI_DEV_PER_COI_DISC_FLAG(EPP.proposal_number,EPP.person_id,EPP.prop_person_role_id,EPP.PROJECT_ROLE) AS DISCLOSURE_REQUIRED_FLAG,
	...
	INNER JOIN person P ON P.person_id = EPP.person_id
