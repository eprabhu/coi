...
SET JOIN_CONDITION = '';
    ...
    IF AV_DISCLOSURE_ID IS NOT NULL AND (AV_REVIEW_STATUS_CODE IS NULL OR AV_REVIEW_STATUS_CODE NOT IN ('1', '6', '5')) THEN
        ...
        SET LS_DYN_SQL = CONCAT('SELECT DISTINCT t1.PERSON_ENTITY_ID, t1.PERSON_ENTITY_NUMBER, t1.PERSON_ID, t1.ENTITY_ID, t1.ENTITY_NUMBER, t1.INVOLVEMENT_START_DATE, t1.INVOLVEMENT_END_DATE, 
            t2.PRIMARY_NAME as ENTITY_NAME, t2.ENTITY_OWNERSHIP_TYPE_CODE as ENTITY_TYPE_CODE, t2.PHONE_NUMBER as PHONE_NUMBER, t2.IS_ACTIVE AS ENTITY_ACTIVE, t2.VERSION_STATUS AS ENTITY_VERSION_STATUS,
            t4.COUNTRY_NAME as COUNTRY, t3.DESCRIPTION AS ENTITY_TYPE, t1.VERSION_STATUS, t1.IS_FORM_COMPLETED, false AS CAN_DELETE, t1.VERSION_NUMBER
			...
			INNER JOIN ENTITY_OWNERSHIP_TYPE t3 ON t3.OWNERSHIP_TYPE_CODE = t2.ENTITY_OWNERSHIP_TYPE_CODE
            LEFT JOIN COUNTRY t4 ON t4.COUNTRY_CODE = t2.COUNTRY_CODE
			WHERE t.DISCLOSURE_ID =', AV_DISCLOSURE_ID, ' ORDER BY t1.UPDATE_TIMESTAMP DESC');
    ...
    ELSE
        ...
        ELSE
            ...
            SET SELECTED_FIELD_LIST= CONCAT( ' DISTINCT t1.PERSON_ENTITY_ID, t1.PERSON_ENTITY_NUMBER, t1.PERSON_ID, t1.ENTITY_ID, t1.ENTITY_NUMBER, t1.INVOLVEMENT_START_DATE, t1.INVOLVEMENT_END_DATE,
                                    t2.PRIMARY_NAME as ENTITY_NAME, t2.ENTITY_OWNERSHIP_TYPE_CODE as ENTITY_TYPE_CODE, t2.PHONE_NUMBER as PHONE_NUMBER, t2.IS_ACTIVE AS ENTITY_ACTIVE, t2.VERSION_STATUS AS ENTITY_VERSION_STATUS,
                                    t4.COUNTRY_NAME as COUNTRY, t3.DESCRIPTION AS ENTITY_TYPE, t1.VERSION_STATUS, t1.IS_FORM_COMPLETED,
        ...
        SET LS_DYN_SQL = CONCAT(' SELECT', SELECTED_FIELD_LIST, '  FROM PERSON_ENTITY t1 INNER JOIN ENTITY t2
            ON t2.ENTITY_ID = t1.ENTITY_ID INNER JOIN ENTITY_OWNERSHIP_TYPE t3 ON t3.OWNERSHIP_TYPE_CODE = t2.ENTITY_OWNERSHIP_TYPE_CODE LEFT JOIN COUNTRY t4 ON t4.COUNTRY_CODE = t2.COUNTRY_CODE ', JOIN_CONDITION, '
