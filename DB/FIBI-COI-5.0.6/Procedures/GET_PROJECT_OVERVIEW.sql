...
SET LS_OFFSET = (AV_LIMIT * AV_PAGED);
    ...
    SET LS_JOIN_CONDITION = CONCAT(LS_JOIN_CONDITION, ' INNER JOIN PERSON T2 ON T1.KEY_PERSON_ID = T2.PERSON_ID
														...
														left JOIN (
															SELECT t1.MODULE_ITEM_KEY, t1.MODULE_CODE, t0.DISCLOSURE_ID, t0.PERSON_ID, t0.FCOI_TYPE_CODE, t0.REVIEW_STATUS_CODE
															FROM COI_DISCL_PROJECTS t1
															INNER JOIN COI_DISCLOSURE t0 on t0.DISCLOSURE_ID = t1.DISCLOSURE_ID
															where T0.FCOI_TYPE_CODE <> 1
														) T6 ON T6.MODULE_ITEM_KEY = T1.EXTERNAL_SYSTEM_REF_ID AND T6.MODULE_CODE = T1.COI_PROJECT_TYPE_CODE AND T6.PERSON_ID = T1.KEY_PERSON_ID
