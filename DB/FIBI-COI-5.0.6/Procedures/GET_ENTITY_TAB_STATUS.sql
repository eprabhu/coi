...
SELECT EFST.DESCRIPTION, EFST.FEED_STATUS_CODE  INTO LS_ESI_FEED_STATUS, LS_ESI_FEED_STATUS_CODE 
FROM entity_sponsor_info ESI 
INNER JOIN entity_feed_status_type EFST ON ESI.FEED_STATUS_CODE = EFST.FEED_STATUS_CODE
WHERE ESI.ENTITY_ID = AV_ENTITY_ID;

SELECT EFST.DESCRIPTION, EFST.FEED_STATUS_CODE INTO LS_ESOI_FEED_STATUS, LS_ESOI_FEED_STATUS_CODE
FROM entity_sub_org_info ESOI
