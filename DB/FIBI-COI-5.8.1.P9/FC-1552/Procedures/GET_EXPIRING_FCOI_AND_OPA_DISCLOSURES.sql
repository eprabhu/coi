...
BEGIN
    ...
    FCOI_LOOP: LOOP
        ...
        INSERT INTO TEMP_EXPIRING_DISCL_TO_NOTIFY (DISCLOSURE_ID, DISCLOSURE_NUMBER, PERSON_ID, DISCLOSURE_TYPE, EXPIRATION_DATE, DAYS_TO_DUE_DATE, VERSION_STATUS, CERTIFICATION_DATE, DISPOSITION_STATUS, REPORTER_NAME, DEPARTMENT_NUMBER, DEPARTMENT_NAME)
        SELECT 
            CD.DISCLOSURE_ID,
            ...
            CD.VERSION_STATUS,
            CD.CERTIFIED_AT AS CERTIFICATION_DATE,
