...
SET SQL_SAFE_UPDATES = 0;
	...
	IF AV_PERSON_ID IS NOT NULL THEN
        ...
        WHERE t1.FCOI_TYPE_CODE = 2 AND t1.REVIEW_STATUS_CODE in ('1','5','6') AND t2.MODULE_ITEM_KEY = AV_MODULE_ITEM_KEY AND t2.MODULE_CODE = AV_MODULE_CODE AND t1.PERSON_ID = AV_PERSON_ID;
        ...
        SET t1.DISPOSITION_STATUS_CODE = 2, t1.REMARK = AV_REMARK,
        t1.UPDATE_TIMESTAMP = UTC_TIMESTAMP()
        WHERE t1.FCOI_TYPE_CODE = 2 AND t1.REVIEW_STATUS_CODE in ('1','5','6')  AND t2.MODULE_ITEM_KEY = AV_MODULE_ITEM_KEY AND t2.MODULE_CODE = AV_MODULE_CODE;
