...
VALUES 
(CONCAT(LS_PREFIX, LS_OPA_DISCLOSURE_NUMBER), LI_OPA_CYCLE_NUMBER, AV_PERSON_ID, LI_OPA_PERSON_ID, AV_HOME_UNIT, AV_LOGGEDIN_USER, UTC_TIMESTAMP(), AV_PERSON_ID, UTC_TIMESTAMP(), LS_OPA_REVIEW_STATUS_CODE, LS_DISPOSITION_STATUS_CODE, LS_VERSION_STATUS, LS_VERSION_NUMBER);
