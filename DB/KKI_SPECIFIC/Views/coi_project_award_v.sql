...
CREATE VIEW `coi_project_award_v` AS
    SELECT 
        ...
        `coi_int_stage_award`.`OVERALL_DISCLOSURE_STATUS` AS `OVERALL_DISCLOSURE_STATUS`,
        `coi_int_stage_award`.`OVERALL_DISCL_REVIEW_STATUS` AS `OVERALL_DISCL_REVIEW_STATUS`,
        `coi_int_stage_award_person`.`NEW_DISCLOSURE_REQUIRED` AS `NEW_DISCLOSURE_REQUIRED`,
