...
-- Unrevised SFI check
   SELECT COUNT(*) > 0 INTO LI_SFI_FLAG 
    ...
    /* INSERT INTO ERROR_MESSAGE (VALIDATION_TYPE, VALIDATION_MSG_TYPE, MESSAGE, PROJ_SFI_DETAILS) (SELECT DISTINCT 'VE' AS VALIDATION_TYPE, 'PS' AS VALIDATION_MSG_TYPE,  "Your SFIs are changed. Kindly make necessary changes" AS LS_ERROR_MSG,
        CONCAT('DisclDetailId:: ', T1.DISCLOSURE_DETAILS_ID, '||', 'Title:: ', COALESCE(T5.TITLE, T6.TITLE), '||', 'Entity:: ', T7.ENTITY_NAME, '||',
        'ModuleCode:: ', COALESCE(T5.COI_PROJECT_TYPE_CODE, T6.COI_PROJECT_TYPE_CODE), '||', 'ModuleItemKey:: ', COALESCE(T5.EXTERNAL_SYSTEM_REF_ID, T6.EXTERNAL_SYSTEM_REF_ID)) as LS_PROJ_SFI_LIST
        FROM COI_DISCL_ENT_PROJ_DETAILS T1
   ...
   IF LI_SFI_FLAG THEN
        INSERT INTO ERROR_MESSAGE (VALIDATION_TYPE, VALIDATION_MSG_TYPE, MESSAGE, SFIs) (SELECT DISTINCT 'VE' AS VALIDATION_TYPE, 'INS' AS VALIDATION_MSG_TYPE,  "Your have incomplete SFIs, please make necessary changes and complete." AS LS_ERROR_MSG,
