        ...
        (SELECT ROLE_ID,RT.RIGHT_NAME 
           FROM ROLE_RIGHTS RR,
            ...
            WHERE RR.RIGHT_ID = RT.RIGHT_ID
			 ...
			 'VIEW_SAP_FEED', 'CREATE_PROPOSAL','MAINTAIN_EXTERNAL_USER','MAINTAIN_INTERFACE_PROCESSING', 'MAINTAIN_MANPOWER_FEED','MAINTAIN_INVOICE_FEED','VIEW_INVOICE_FEED','MAINTAIN_INVOICE_INTERFACE_PROCESSING','MAINTAIN_KEY_PERSON_TIMESHEET','VIEW_KEY_PERSON_TIMESHEET'
    )
        ) RLE
