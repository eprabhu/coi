...
DECLARE LI_COPIED_ENTITY_ID 		INT;
    ...
    */
	...
	INSERT INTO ENTITY_SPONSOR_INFO
		...
		DUNNING_CAMPAIGN_ID, CUSTOMER_NUMBER, UPDATE_TIMESTAMP, UPDATED_BY,
		SPONSOR_NAME, TRANSLATED_NAME, DUNS_NUMBER, UEI_NUMBER, CAGE_NUMBER, PRIMARY_ADDRESS_LINE_1, PRIMARY_ADDRESS_LINE_2, CITY, STATE, POST_CODE,
        COUNTRY_CODE, EMAIL_ADDRESS, PHONE_NUMBER, IS_COPY, COMMENTS FROM ENTITY_SPONSOR_INFO WHERE ENTITY_ID = AV_ENTITY_ID;
	...
	INSERT INTO ENTITY_SUB_ORG_INFO
        ...
        ORGANIZATION_NAME, DUNS_NUMBER, UEI_NUMBER, CAGE_NUMBER, PRIMARY_ADDRESS_LINE_1, PRIMARY_ADDRESS_LINE_2, CITY, STATE, POST_CODE, COUNTRY_CODE, EMAIL_ADDRESS,
        PHONE_NUMBER, HUMAN_SUB_ASSURANCE, ANIMAL_WELFARE_ASSURANCE, ANIMAL_ACCREDITATION, CONGRESSIONAL_DISTRICT, INCORPORATED_IN, INCORPORATED_DATE,
        NUMBER_OF_EMPLOYEES, FEDERAL_EMPLOYER_ID, IS_COPY FROM ENTITY_SUB_ORG_INFO WHERE ENTITY_ID = AV_ENTITY_ID;
