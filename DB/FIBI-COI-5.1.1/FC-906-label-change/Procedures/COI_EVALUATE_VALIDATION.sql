...
BEGIN
  ...
  -- Unrevised SFI check
     ...
     IF LI_SFI_FLAG THEN
          INSERT INTO ERROR_MESSAGE (VALIDATION_TYPE, VALIDATION_MSG_TYPE, MESSAGE, SFIs) (SELECT DISTINCT 'VE' AS VALIDATION_TYPE, 'INS' AS VALIDATION_MSG_TYPE,  "You have incomplete Engagement (s), please make necessary changes and complete." AS LS_ERROR_MSG,
