...
SET JOIN_CONDITION = '';
    ...
    ELSE
        ...
        SET LS_DYN_SQL = CONCAT(' SELECT', SELECTED_FIELD_LIST, '  FROM PERSON_ENTITY t1 INNER JOIN ENTITY t2
            ON t2.ENTITY_ID = t1.ENTITY_ID LEFT JOIN ENTITY_OWNERSHIP_TYPE t3 ON t3.OWNERSHIP_TYPE_CODE = t2.ENTITY_OWNERSHIP_TYPE_CODE LEFT JOIN COUNTRY t4 ON t4.COUNTRY_CODE = t2.COUNTRY_CODE ', JOIN_CONDITION, '
