...
BEGIN
    ...
    IF overview_valid THEN
        SET validation_message = 'Overview Information is fully filled';
        SET validation_type = null;
    ELSE
        SET validation_message = 'Overview Information is not fully filled';
    ...
    IF sponsor_valid THEN
        SET validation_message = 'Sponsor Information is fully filled';
        SET validation_type = null;
    ELSE
        SET validation_message = 'Sponsor Information is not fully filled';
    ...
    IF organization_valid THEN
        SET validation_message = 'Organization Information is fully filled';
        SET validation_type = null;
    ELSE
        SET validation_message = 'Organization Information is not fully filled';
        SET validation_type = 'VW';
        SET all_null = FALSE;
    END IF;
