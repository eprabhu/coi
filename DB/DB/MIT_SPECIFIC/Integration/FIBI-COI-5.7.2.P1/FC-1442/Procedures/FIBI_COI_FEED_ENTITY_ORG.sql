            ...
            IF (UPPER(IS_ORGANIZATION_SYNC_FLAG) = 'TRUE' OR IS_ORGANIZATION_SYNC_FLAG = 1) THEN
                ...
                BEGIN
                    IF AV_ORGANIZATION_ID IS NULL THEN
                        ...
                        VALUES (LI_SEQ_ORGANIZATION_ID, AV_PRIMARY_NAME, AV_ROLODEX_ID, LS_ADDRESS, LS_CABLE_ADDRESS, AV_TELEPHONE_NUMBER, LS_COUNTY, AV_CONGRESSIONAL_DISTRICT,
                    ...
                    ELSE
                        ...
                        UPDATE ORGANIZATION SET ORGANIZATION_NAME = AV_PRIMARY_NAME, CONTACT_ADDRESS_ID = AV_ROLODEX_ID, ADDRESS = LS_ADDRESS,
                        TELEX_NUMBER = AV_TELEPHONE_NUMBER, COUNTY = LS_COUNTY, CONGRESSIONAL_DISTRICT = AV_CONGRESSIONAL_DISTRICT, INCORPORATED_IN = AV_INCORPORATED_IN,
