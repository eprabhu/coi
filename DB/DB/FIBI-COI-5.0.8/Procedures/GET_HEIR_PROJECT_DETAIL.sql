	...
	IF LS_COUNT > 0 THEN 
		IF AV_MODULE_CODE = 1 THEN 
			...
			SELECT DISTINCT 
				...
				,T16.HOME_UNIT AS KEY_PERSON_UNIT,T17.UNIT_NAME AS KEY_PERSON_UNIT_NAME
			...
			LEFT JOIN PERSON T16 ON T16.PERSON_ID = T7.KEY_PERSON_ID
	...
	ELSE
		IF AV_MODULE_CODE = 1 THEN 
			...
			SELECT DISTINCT 
				...
				,T20.HOME_UNIT AS KEY_PERSON_UNIT,T21.UNIT_NAME AS KEY_PERSON_UNIT_NAME
            FROM AWARD T12
			INNER JOIN COI_PROJECT_TYPE T5 ON T5.COI_PROJECT_TYPE_CODE = AV_MODULE_CODE
