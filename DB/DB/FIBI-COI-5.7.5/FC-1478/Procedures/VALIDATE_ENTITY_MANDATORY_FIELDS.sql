...
BEGIN
    ...
    IF LI_SPONSOR_NAME_LENGTH_EXCEEDED > 0 AND LI_SPONSOR_ADDRESS_LENGTH_EXCEEDED > 0 THEN
        SET validation_message = CONCAT('Sponsor Name exceeds ', LI_MAX_NAME_LENGTH, ' characters and Address Line 1 / Address Line 2 exceeds ', LI_MAX_ADDRESS_LINE_LENGTH, ' characters.');
        SET validation_type = 'VE';
        SET all_null = FALSE;
    ...
    ELSEIF LI_SPONSOR_ADDRESS_LENGTH_EXCEEDED > 0 THEN
        SET validation_message = CONCAT('Address Line 1 / Address Line 2 exceeds ', LI_MAX_ADDRESS_LINE_LENGTH, ' characters.');
        SET validation_type = 'VE';
        SET all_null = FALSE;
    ELSE
    ...
    IF LI_ORG_NAME_LENGTH_EXCEEDED > 0 AND LI_ORG_ADDRESS_LENGTH_EXCEEDED > 0 THEN
        SET validation_message = CONCAT('Organization Name exceeds ', LI_MAX_NAME_LENGTH,  ' characters and Address Line 1 / Address Line 2 exceeds ', LI_MAX_ADDRESS_LINE_LENGTH, ' characters.');
        SET validation_type = 'VE';
        SET all_null = FALSE;
