...
CASE 
	...
	', LS_FILTER_CONDITION, ' GROUP BY T1.EXTERNAL_SYSTEM_REF_ID , T1.KEY_PERSON_ID,T1.KEY_PERSON_ROLE_CODE )T1', LS_OUTER_FILTER_CONDITION, ifnull(LS_ORDER_BY,''),' )T '
