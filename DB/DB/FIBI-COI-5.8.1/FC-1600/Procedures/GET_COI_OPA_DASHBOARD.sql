...
END IF;
    ...
    ELSEIF AV_TAB_TYPE = 'MY_REVIEWS' THEN
        ...
        SET LS_FILTER_CONDITION = CONCAT(' T1.REVIEW_STATUS_CODE IN (3,4,7,8,9) AND ((T8.ASSIGNEE_PERSON_ID = ''', AV_PERSON_ID ,'''
    ...
    ELSE
        ...
        SET OPA_SELECTED_FIELDS= CONCAT('T1.OPA_DISCLOSURE_ID, T1.OPA_DISCLOSURE_NUMBER, T1.OPA_CYCLE_NUMBER,
            ...
            CASE    WHEN T8.ASSIGNEE_PERSON_ID IS NULL THEN CONCAT(T15.DESCRIPTION, " : ", "null", " : ",T14.DESCRIPTION, " : ",T14.REVIEW_STATUS_CODE)
					...
					END
			SEPARATOR ";") AS REVIEWERS, T1.VERSION_NUMBER, T1.VERSION_STATUS, T1.EXPIRATION_DATE, IFNULL(T19.COMMENT_COUNT, 0) AS DISCLOSURE_COMMENT_COUNT, T3.DISPLAY_NAME ');
