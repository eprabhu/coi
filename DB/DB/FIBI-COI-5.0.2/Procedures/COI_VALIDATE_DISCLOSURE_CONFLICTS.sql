...
CREATE PROCEDURE `COI_VALIDATE_DISCLOSURE_CONFLICTS`(
    ...
    */
    IF LI_CONFLICT_COUNT != 0 THEN
            ...
            UPDATE COI_DISCLOSURE SET CONFLICT_STATUS_CODE = 3, UPDATE_USER = AV_UPDATE_USER, UPDATE_TIMESTAMP = utc_timestamp() WHERE DISCLOSURE_ID = AV_DISCLOSURE_ID;
    ...
    ELSEIF LI_CONFLICT_COUNT = 0 THEN
        ...
        */
        IF LI_POTENTIAL_CONFLICT_COUNT != 0 THEN
            ...
            UPDATE COI_DISCLOSURE SET CONFLICT_STATUS_CODE = 2, UPDATE_USER = AV_UPDATE_USER, UPDATE_TIMESTAMP = utc_timestamp() WHERE DISCLOSURE_ID = AV_DISCLOSURE_ID;
    ...
    IF LI_POTENTIAL_CONFLICT_COUNT = 0 THEN
        ...
        */
        IF LI_NO_CONFLICT_COUNT != 0 THEN
            ...
            UPDATE COI_DISCLOSURE SET CONFLICT_STATUS_CODE = 1, UPDATE_USER = AV_UPDATE_USER, UPDATE_TIMESTAMP = utc_timestamp() WHERE DISCLOSURE_ID = AV_DISCLOSURE_ID;
    ...
    IF LI_NO_CONFLICT_COUNT = 0 THEN
		...
		ELSE
			...
			UPDATE COI_DISCLOSURE SET CONFLICT_STATUS_CODE = 4, UPDATE_USER = AV_UPDATE_USER, UPDATE_TIMESTAMP = utc_timestamp() WHERE DISCLOSURE_ID = AV_DISCLOSURE_ID;
