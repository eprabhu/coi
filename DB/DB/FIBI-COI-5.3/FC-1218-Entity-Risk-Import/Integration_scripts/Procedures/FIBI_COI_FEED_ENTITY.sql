...
BEGIN
		...
		ELSE
		    ...
		    UPDATE ORGANIZATION_TYPE SET ORGANIZATION_TYPE_CODE = AV_ORGANIZATION_TYPE_CODE, UPDATE_TIMESTAMP = SYSDATE(), UPDATE_USER = LS_UPDATE_USER, VER_NBR = LI_VER_NBR, OBJ_ID = SYS_GUID()
		    WHERE ORGANIZATION_ID = AV_ORGANIZATION_ID;
