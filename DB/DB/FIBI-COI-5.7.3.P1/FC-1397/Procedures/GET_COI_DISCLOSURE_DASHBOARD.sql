...
ELSEIF AV_TAB_TYPE = 'TRAVEL_DISCLOSURES' THEN
		...
		SET LS_DYN_SQL = CONCAT(' SELECT DISTINCT *  FROM(SELECT DISTINCT
                           ...
                           T49.TRAVEL_DESTINATIONS,
                            ...
                            FN_DISCLOSURE_TOTAL_COMMENT_COUNT(T21.TRAVEL_DISCLOSURE_ID, ''', AV_PERSON_ID, ''', ', LI_MODULE_CODE, ') AS DISCLOSURE_COMMENT_COUNT',SELECTED_FIELD_LIST,'
...
ELSE
        ...
        SET LS_DYN_SQL =CONCAT('SELECT DISTINCT *  FROM(SELECT DISTINCT
										...
										FN_DISCLOSURE_TOTAL_COMMENT_COUNT(T1.DISCLOSURE_ID, ''', AV_PERSON_ID, ''', ', LI_MODULE_CODE, ') AS DISCLOSURE_COMMENT_COUNT', SELECTED_FIELD_LIST, '
