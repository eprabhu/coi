...
BEGIN
    ...
    SET LS_DYN_SQL = CONCAT(
							...
							' FROM (WITH Awards AS (
							 ...
							 SELECT * FROM Awards WHERE AWARD_STATUS_CODE NOT IN (2,5) AND
							 							PROJECT_NUMBER NOT IN (
																...
																WHERE MODULE_CODE = 1 AND C1.DISPOSITION_STATUS_CODE <> 2 AND PERSON_ID = ''', AV_PERSON_ID, ''' 
																...
																AND (C3.DISCLOSURE_VALIDATION_FLAG IS NULL OR C3.DISCLOSURE_VALIDATION_FLAG = ''HIERARCHY'') 
																	...
																	WHERE DISPOSITION_STATUS_CODE = 1 AND PERSON_ID = ''', AV_PERSON_ID, ''' AND PROJECT_NUMBER = CD2.MODULE_ITEM_KEY
																)
												...
												WHERE CDP.MODULE_CODE = 1 AND CDH.DISPOSITION_STATUS_CODE <> 2
												  AND CDH.PERSON_ID = ''', AV_PERSON_ID, ''' 
