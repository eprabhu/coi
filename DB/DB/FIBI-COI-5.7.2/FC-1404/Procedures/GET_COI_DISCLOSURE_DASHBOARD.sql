...
ELSEIF AV_TAB_TYPE = 'TRAVEL_DISCLOSURES' THEN
		...
		SET LS_DYN_SQL = CONCAT(' SELECT DISTINCT *  FROM(SELECT DISTINCT
                           ...
                           T49.TRAVEL_DESTINATIONS,
							...
							T51.ADMIN_GROUP_NAME ',SELECTED_FIELD_LIST,'
                            ...
                            LEFT JOIN ( SELECT TD.TRAVEL_DISCLOSURE_ID, GROUP_CONCAT(DISTINCT c.COUNTRY_NAME ORDER BY c.COUNTRY_NAME ASC SEPARATOR '','') AS TRAVEL_DESTINATIONS FROM COI_TRAVEL_DESTINATIONS TD
