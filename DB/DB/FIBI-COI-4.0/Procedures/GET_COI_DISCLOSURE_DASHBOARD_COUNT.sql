...
IF AV_TAB_TYPE = 'TRAVEL_DISCLOSURES' THEN
		...
		IF AV_SEARCHWORD IS NOT NULL THEN
			...
			T5.UNIT_NAME LIKE ', AV_SEARCHWORD, ' OR T24.DESCRIPTION LIKE ', AV_SEARCHWORD, '  OR T29.RELATIONSHIP_TYPES LIKE ', AV_SEARCHWORD, 
...
*/
		IF AV_SEARCHWORD IS NOT NULL THEN
			...
			T20.UNIT_NAME LIKE ', AV_SEARCHWORD, ' OR T14.PROPOSAL_TITLES LIKE ', AV_SEARCHWORD, '  OR T15.AWARD_TITLES LIKE ', AV_SEARCHWORD, 
