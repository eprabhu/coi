...
-- Possbile Return values are NOT_REQUIRED, REQUIRED, TO_BE_DETERMINED
    ...
    inner join questionnaire_answer t1 on t1.questionnaire_ah_id_fk = t0.questionnaire_answer_header_id
	...
	and t1.questionnaire_ah_id_fk = (select max(questionnaire_answer_header_id)
									from questionnaire_answer_header where module_Item_code = '3' 
