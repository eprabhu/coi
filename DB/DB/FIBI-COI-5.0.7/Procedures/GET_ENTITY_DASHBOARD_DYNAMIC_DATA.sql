...
IF AV_TYPE = 'A' THEN
	...
	IF AV_PRIMARY_ADDRESS_LINE_1 IS NOT NULL  AND AV_PRIMARY_ADDRESS_LINE_1 <> '' THEN
			SET LS_FILTER_CONDITION = CONCAT(LS_FILTER_CONDITION,' T.PRIMARY_ADDRESS_LINE_1 LIKE ''%',AV_PRIMARY_ADDRESS_LINE_1,'%'' AND ');
	END IF;
	IF AV_PRIMARY_ADDRESS_LINE_2 IS NOT NULL  AND AV_PRIMARY_ADDRESS_LINE_2 <> '' THEN
			SET LS_FILTER_CONDITION = CONCAT(LS_FILTER_CONDITION,' T.PRIMARY_ADDRESS_LINE_1 LIKE ''%',AV_PRIMARY_ADDRESS_LINE_2,'%'' AND ');
	END IF;
