...
DECLARE LS_COI_LOG_DESCRIPTION VARCHAR(200);
    ...
    INSERT INTO TEMP_EXPIRED_DISCLOSURES_TO_NOTIFY (DISCLOSURE_ID, DISCLOSURE_NUMBER, PERSON_ID, DISCLOSURE_TYPE)
    SELECT 
        D.OPA_DISCLOSURE_ID,        
    ...
    -- MARK EXPIRED FOR LEGACY COI DISCLOSURES
        ...
        INSERT INTO TEMP_EXPIRED_DISCLOSURES_TO_NOTIFY (DISCLOSURE_ID, DISCLOSURE_NUMBER, PERSON_ID, DISCLOSURE_TYPE, IS_LEGACY_DISCLOSURE)
        SELECT
            DISTINCT
