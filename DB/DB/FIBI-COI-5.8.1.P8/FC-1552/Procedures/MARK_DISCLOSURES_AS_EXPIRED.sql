...
DECLARE LS_COI_LOG_DESCRIPTION VARCHAR(200);
    ...
    INSERT INTO TEMP_EXPIRED_DISCLOSURES_TO_NOTIFY (DISCLOSURE_ID, DISCLOSURE_NUMBER, PERSON_ID, DISCLOSURE_TYPE, EXPIRATION_DATE, VERSION_STATUS)
    SELECT 
        D.OPA_DISCLOSURE_ID,        
    ...
    INSERT INTO TEMP_EXPIRED_DISCLOSURES_TO_NOTIFY (DISCLOSURE_ID, DISCLOSURE_NUMBER, PERSON_ID,  DISCLOSURE_TYPE, EXPIRATION_DATE, CERTIFICATION_DATE, VERSION_STATUS)
    SELECT 
        CD.DISCLOSURE_ID,
