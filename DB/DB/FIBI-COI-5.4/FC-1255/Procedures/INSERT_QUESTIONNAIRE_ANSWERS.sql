...
DECLARE	LI_SUB_MODULE_ITEM_CODE int(3) ;

SELECT MODULE_ITEM_CODE, MODULE_SUB_ITEM_CODE INTO LI_MODULE_ITEM_CODE, LI_SUB_MODULE_ITEM_CODE 
FROM QUEST_ANSWER_HEADER WHERE QUESTIONNAIRE_ANS_HEADER_ID = AV_QUESTIONNAIRE_ANS_HEADER_ID;

IF (LI_MODULE_ITEM_CODE IN(8,26) AND LI_SUB_MODULE_ITEM_CODE <> 801) THEN
