...
DECLARE LS_FOOTER_DESCRIPTION TEXT;
    ...
    SELECT
    LS_QST_ANS_HEADER_ID,AV_QUESTIONNAIRE_ID, MODULE_ITEM_CODE, MODULE_SUB_ITEM_CODE, COALESCE(AV_MODULE_ITEM_KEY, MODULE_ITEM_KEY), AV_MODULE_SUB_ITEM_KEY, CASE 
        WHEN AV_IS_QNR_IDENTICAL = 'Y' THEN QUESTIONNAIRE_COMPLETED_FLAG
        ELSE 'N'
    END, UTC_TIMESTAMP(),AV_UPDATE_USER
