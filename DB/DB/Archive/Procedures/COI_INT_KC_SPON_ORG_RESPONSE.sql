...
IF AV_SPON_FEED_STATUS IS NOT NULL THEN
	...
	IF LS_CURRENT_STATUS <> LS_PREV_STATUS THEN
		...
		(ENTITY_ID, ENTITY_NUMBER, ACTION_TYPE_CODE, DESCRIPTION, COMMENT, UPDATE_TIMESTAMP, UPDATED_BY)
		VALUES 
		(AV_ENTITY_ID, AV_ENTITY_ID, 10, LS_ACTION_MSGE, NULL, AV_UPDATE_TIMESTAMP, 'system');
...
IF AV_ORG_FEED_STATUS IS NOT NULL THEN
	...
	IF LS_CURRENT_STATUS <> LS_PREV_STATUS THEN
		...
		(ENTITY_ID, ENTITY_NUMBER, ACTION_TYPE_CODE, DESCRIPTION, COMMENT, UPDATE_TIMESTAMP, UPDATED_BY)
		VALUES 
		(AV_ENTITY_ID, AV_ENTITY_ID, 11, LS_ACTION_MSGE,NULL, AV_UPDATE_TIMESTAMP, 'system');
