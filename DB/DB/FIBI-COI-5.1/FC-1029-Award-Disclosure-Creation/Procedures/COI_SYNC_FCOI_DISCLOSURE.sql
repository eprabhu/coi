    				...
    				AND (
    					...
    					(T1.MODULE_CODE = 1 AND T1.MODULE_ITEM_KEY NOT IN (
							...
							LEFT JOIN (SELECT AW2.PROJECT_NUMBER
										...
										AND T6.PERSON_ID = AV_PERSON_ID ) T5 ON T5.PROJECT_NUMBER = T1.AWARD_NUMBER  
										
    						WHERE T1.KEY_PERSON_ID = AV_PERSON_ID AND T1.PERSON_STATUS != 'I'
    						AND ((T1.DISCLOSURE_REQUIRED_FLAG IS NOT NULL AND T1.DISCLOSURE_REQUIRED_FLAG = 'REQUIRED') 
								OR (T1.DISCLOSURE_VALIDATION_FLAG IS NOT NULL AND T1.DISCLOSURE_VALIDATION_FLAG = 'SELF') 
								OR (T1.DISCLOSURE_REQUIRED_FLAG IS NOT NULL AND T1.DISCLOSURE_REQUIRED_FLAG = 'REQUIRED'
