...
DECLARE LI_SPNSR_ADDRESS_COUNT			INT(11);
...
SELECT COUNT(*) INTO LI_SPNSR_ADDRESS_COUNT
FROM ENTITY_MAILING_ADDRESS EMA
WHERE EMA.ENTITY_ID = AV_ENTITY_ID
...
SELECT 
    ...
    CASE 
    WHEN LI_E_COUNT > 0 
         AND LI_SPNSR_ADDRESS_COUNT > 0 
         AND LI_ORG_ADDRESS_COUNT > 0 
    THEN TRUE
    ELSE FALSE 
