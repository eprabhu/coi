...
DECLARE AV_ENTITY_SOURCE_TYPE_CODE		varchar(3);
...
IF AV_TYPE = 'A' THEN
	...
	IF AV_ENTITY_SOURCE_TYPE_CODE IS NOT NULL AND AV_ENTITY_SOURCE_TYPE_CODE <> '' THEN
	        SET LS_FILTER_CONDITION = CONCAT(LS_FILTER_CONDITION,' T.ENTITY_SOURCE_TYPE_CODE =''',AV_ENTITY_SOURCE_TYPE_CODE,''' AND ');
	END IF;
END IF;
			...
			FROM (
				SELECT DISTINCT
                    ...
                    (SELECT GROUP_CONCAT(FTRT.DESCRIPTION SEPARATOR ''|| '') FROM ENTITY_FAMILY_TREE_ROLE  FTR
                        ...
                        WHERE FTR.ENTITY_ID = T1.ENTITY_ID)  AS FAMILY_ROLE_TYPES,
