...
VALUES 
(CONCAT(LS_PREFIX, AV_OPA_DISCLOSURE_NUMBER), LI_OPA_CYCLE_NUMBER, AV_PERSON_ID, LS_PERSON_NAME, AV_HOME_UNIT, LS_IS_FACULTY, AV_LOGGEDIN_USER, UTC_TIMESTAMP(), AV_PERSON_ID, UTC_TIMESTAMP(), LS_OPA_REVIEW_STATUS_CODE, LS_DISPOSITION_STATUS_CODE, LS_VERSION_STATUS, LS_VERSION_NUMBER + 1);
