...
BEGIN
	...
	ELSEIF AV_MODULE_CODE = 3 THEN
		...
		IF AV_DISCLOSURE_ID is not null THEN
            ...
            AND T2.PROPOSAL_STATUS not IN ("Unsuccessful","Inactive","Revision Requested",
            "ORT Director Review Completed","Pending Revisions By PI","Pending Revisions By PI","Not Submitted","Returned","Withdrawn")
            AND T1.DISCLOSURE_ID= AV_DISCLOSURE_ID  
            AND T2.KEY_PERSON_ID = AV_PERSON_ID;
