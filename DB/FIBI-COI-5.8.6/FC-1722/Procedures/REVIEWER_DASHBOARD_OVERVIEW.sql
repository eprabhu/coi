...
*/
    ...
    DECLARE LS_SQL_OPA_UNIT_CHK_CON     LONGTEXT;
    ...
    IF AV_FETCH_TYPE = 'HEADER' THEN
        ...
        IF LI_IS_WIDGET_ACTIVE = TRUE AND (LI_IS_WIDGET_SELECTED = TRUE OR LI_HAS_USER_PREFERENCE = FALSE) THEN
            ...
            ELSE
                SET LS_SQL_OPA_UNIT_CHK_CON = CONCAT(' )');
            END IF;

            SET LS_SQL_OPA_DELINQUENT = CONCAT(LS_SQL_OPA_DELINQUENT, LS_SQL_OPA_UNIT_CHK_CON);
            SET LS_SQL_OPA_EXEMPT = CONCAT(LS_SQL_OPA_EXEMPT, LS_SQL_OPA_UNIT_CHK_CON);
            SET LS_SQL_OPA_ELIGIBLE_PERSONS = CONCAT(LS_SQL_OPA_ELIGIBLE_PERSONS, LS_SQL_OPA_UNIT_CHK_CON);
