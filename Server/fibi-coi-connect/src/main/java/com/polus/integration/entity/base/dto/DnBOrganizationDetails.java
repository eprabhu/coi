...
public class DnBOrganizationDetails {
	...
	public static class CorporateLinkage {
		...
		private DunInfo globalUltimate;
		private DunInfo parent;
	}
	...
	@Data
	@JsonIgnoreProperties(ignoreUnknown = true)
	public static class BusinessEntityType {
		private String description;
		private int dnbCode;
	}
	...
	public static class MultilingualPrimaryName {
		private DnBEnrichAPIResponse.DefaultType language;
		private String name;
	}
