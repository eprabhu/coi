...
public class DisclAttachment implements Serializable{
	...
	@JoinColumn(name = "DISCLOSURE_ID", referencedColumnName = "DISCLOSURE_ID", foreignKey = @ForeignKey(name = "DISCL_ATTACHMENT_FK1"), insertable = false, updatable = false)
	private CoiDisclosure coiDisclosure;

	@ManyToOne(optional = true)
	@JoinColumn(name = "ATTACHMENT_TYPE_CODE", referencedColumnName = "ATTA_TYPE_CODE", foreignKey = @ForeignKey(name = "DISCL_ATTACHMENT_FK2"), insertable = false, updatable = false)
